  ...
  return (
    ...
    >
      <div className="max-w-7xl py-4 px-4 md:px-8 lg:px-10">
        ...
        Our Simple 6-Step Process: From Concept to Completion
        </h2>
        <p className="text-neutral-700 text-center dark:text-neutral-300 text-sm md:text-base">
        We believe in making your experience seamless and stress-free. Here’s how we bring your vision to life:
        </p>
      </div>
